...
public class DataHelper {
	...
	private class Cache extends LinkedHashMap<String, NamedStatement> {
		...
		@Override
		protected boolean removeEldestEntry(Map.Entry<String, NamedStatement> eldest) {
			return size() > 20;
		}
	}

	private final HelperConnection connection;
	private Cache cachedStatements = new Cache();
	...
	public String dumpSql(String sql, MappedParameters params) {
...
//        }
		...
		try {
			...
			for (List<String> rowData : data) {
				...
				builder.append(printRow).append("\n");
